  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // New subtle shadows
        'neu-light-subtle': '2px 2px 4px rgba(208,208,208,0.7), -2px -2px 4px rgba(255,255,255,0.7)',
        'neu-light-subtle-pressed': 'inset 1.5px 1.5px 3px rgba(208,208,208,0.7), inset -1.5px -1.5px 3px rgba(255,255,255,0.7)',
        'neu-dark-subtle': '2px 2px 4px rgba(34,34,34,0.7), -2px -2px 4px rgba(68,68,68,0.7)',
        'neu-dark-subtle-pressed': 'inset 1.5px 1.5px 3px rgba(34,34,34,0.7), inset -1.5px -1.5px 3px rgba(68,68,68,0.7)',
      },
    },
  },
  plugins: [],
