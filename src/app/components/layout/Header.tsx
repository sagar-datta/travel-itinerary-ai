...
export function Header({ isStarted, onTitleClick, showBackButton, onBack }: HeaderProps) {
  return (
    <header className="fixed md:relative top-0 left-0 right-0 z-50 backdrop-blur-xl md:backdrop-blur-none bg-white/10 dark:bg-black/10 md:bg-transparent shadow-sm md:shadow-none">
